                ...
                <div id="mover">
                    <div id="slide-1" class="slide">
                        <div class="slider-img">
                            <a href="preview.html">
                                <img src="temp/images/slide-1-image.png" alt="learn more" /></a>
                        </div>
                    ...
                    <div class="slide">
                        ...
                        <div class="slider-img">
                            <a href="preview.html">
                                <img src="temp/images/slide-3-image.jpg" alt="learn more" /></a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="slide">
                        <div class="slider-img">
                            <a href="preview.html">
                                <img src="temp/images/slide-2-image.jpg" alt="learn more" /></a>
                        </div>
                        <div class="slider-text">
                            <h1>Clearance<br>
                                <span>SALE</span></h1>
            ...
            <asp:Repeater ID="rptNewProduct" runat="server">
                <ItemTemplate>
                    <div class="grid_1_of_4 images_1_of_4">
                        <a href='?f=product&fs=des&id=<%#:Eval("ProDelID") %>'>
                            <img src="/Images/<%#:Eval("vImage") %>" />
                        </a>
                        <h2><a href='?f=product&fs=des&id=<%#:Eval("ProDelID") %>'><%#:Eval("vName") %></a></h2>
